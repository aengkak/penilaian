					 ...
					 if(strtolower($keysub->nama) == "tambahan") {
						 foreach ($tambahan as $keytam => $hariinitam) {
							 if($hariini == $hariinitam) { ?>
								 <input value="<?php echo $hariini.".".$keysub->id_sub.".".$karyawan->id_karyawan;?>" <?php foreach ($nilai as $keyn) { 

...
$(document).ready(function () {
	...
	table = $('#datatable').DataTable({
		...
		"ajax": {
			"url": '<?php echo base_url('jsondivisi'); ?>',
			"type": "POST"
		},
...
function tambah() {
	...
	$("#modalbody").load("modaldivisi/", function (data) {
		$("#modalbody").html(data);
	});
}
...
function ganti(id) {
	...
	$("#modalbody").load("<?php echo base_url();?>editdivisi/" + id, function (data) {
		$("#modalbody").html(data);
	});
}
$("#form").on('submit', (function (e) {
	...
	var url;
	if (simpan == 'tambah') {
		url = "<?php echo base_url();?>adddivisi";
	} else {
...
function hapus(id) {
	swal({
		...
		$.ajax({
			url: "<?php echo site_url('deletedivisi')?>/" + id,
			type: "POST",
			dataType: "JSON",
			success: function (data) {
				table.ajax.reload();
